                ...
                <Card style={{ border: 'none' }} >
                    <Card.Body className="ml-3 mr-3 mt-2 mb-2">
                        <Link style={{ textDecoration: 'none', color: 'black' }} to={"/lista/developers"}>
                            <h5 style={{ fontFamily: 'BoldG', fontSize: 20 }} className="card-title mt-3 ml-3 mb-3">
                                <FiberManualRecordTwoToneIcon
                                    style={{ marginRight: 18, fontSize: 28, marginTop: -3, color: '#43a047' }} />Developers Disponiveis</h5>
                        </Link>
